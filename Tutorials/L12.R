...
### (see mammatus cloud example), so we have to re-fit a bunch of         ###
...
### We can use Haolun's function, which scales each column in x1 so that
...
### of shrinkage using "decay". We also need to specify that we want 
