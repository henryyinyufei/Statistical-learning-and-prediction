...
### We can also fit smoothing splines using CV and GCV. 
### Set cv to TRUE for CV and FALSE for GCV
...
lines(fit.smooth.CV, col=colors()[121], lwd=2)
lines(fit.smooth.GCV, col=colors()[91], lwd=2)
