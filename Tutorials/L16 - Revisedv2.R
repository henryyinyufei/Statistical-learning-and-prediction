...
### node size.
### Let's try 100 trees, interaction depth of 1, shrinkage of 0.1, and bag
### fraction of 0.8
...
fit.gbm.best = gbm(alcohol ~ ., data = data, distribution = "gaussian", 
  n.trees = 10000, interaction.depth = 5, shrinkage = 0.001, bag.fraction = 0.8)
...
data.test.raw = read.csv("Wine Quality - Test.csv")
